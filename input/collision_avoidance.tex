...
% Let us analyse the system in the moving frame with constant velocity, and zero acceleration, in the presence of a constant vectorfield $f(\vecs \xi) = const.$ which is parallel to the surface. 
% In this equation, the variable $\vecs \xi$ is with respect to the moving frame. And hence 
