\documentclass[letterpaper, times, mathptm, 10 pt, conference]{ieeeconf}
...
\newcommand{\editcolor}[1]{\textcolor{blue}{#1}}
...
\author{
  \IEEEauthorblock{Lukas Huber$^{1}$, Trinca Thibaud$^{1}$, Jean-Jacques Slotine$^{2}$, Aude Billard$^{1}$}
